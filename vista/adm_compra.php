                ...
                <div class="card card-success">
                    ...
                    <div class="card-body p-0">
                        <header>
                            ...
                            <h1 class="titulo_cp">PEDIDO DE COMPRA</h1>
                            <div class="datos_cp">
                                ...
                                <div class="form-group row">
                                    <span>DNI: </span>
                                    <div class="input-group-append col-md-6">
                                        <input type="number" class="form-control" id="dni" placeholder="Coloque seu DNI">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span>Vendedor: </span>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-default">
                                        ...
                                        <div class="info-box mb-3 bg-success">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text text-left ">VALOR RECEBIDO</span>
