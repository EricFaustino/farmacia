...
?>
    <title>Adm | Editar Lotes</title>

<?php
include_once 'layouts/nav.php';
?>
<div class="modal fade" id="editarlote" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Editar lote de produto</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-success text-center" id="edit-lote" style="display: none;">
                        <span><i class="fas fa-check m-1"></i>Lote editado com sucesso</span>
                    </div>
                      
                    <form id="form-editar-lote">
                    <div class="form-group">
                        <label for="codigo_lote">Codigo lote: </label>
                        <label id="codigo_lote">codido lote</label>
                    </div>
                    <div class="form-group">
                        <label for="stock">Estoque: </label>
                        <input id="stock" type="number" class="form-control" placeholder="Digite o estoque" require>
                    </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Gestão de lotes</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card card-success">
                    <div class="card-header">
                        ...
                        <div class="input-group">
                            <input type="text" id="buscar-lote" class="form-control float-left" placeholder="Escreva o nome do produto">
