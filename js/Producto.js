$(document).ready(function() {
    ...
    function rellenar_presentaciones() {
        ...
        $.post('../controlador/ApresentacaoController.php', { funcion }, (response) => {
            ...
            productos.forEach(producto => {
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      ...
                      <h2 class="lead"><i class="fas fa-dollar-sign mr-1"><b></i>${producto.precio}</b></h2>
                ...
                <div class="card-footer">
                  <div class="text-right">
                    ...
                    <button class="excluir btn btn-sm btn-danger">
                ...
                $.post('../controlador/ProductoController.php', { id, funcion }, (response) => {
                    ...
                    if (response == 'excluido') {
                        ...
                        swalWithBootstrapButtons.fire(
                            ...
                            'O produto ' + nombre + ' não foi excluido porque esta em um lote!!',
                            'error'
                        )
                    }
                })
